export default function FloatingWhatsApp() {
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      ...
      {/* TOOLTIP */}
      <div className="absolute right-20 bottom-1 opacity-0 group-hover:opacity-100 transition-opacity bg-black/80 text-white text-sm px-3 py-1 rounded-md backdrop-blur-sm">
        Chat WhatsApp
      </div>
      ...
      <a
        ...
        className="bg-[#25D366] hover:bg-[#1ebe5c] text-white w-16 h-16 rounded-full flex items-center justify-center shadow-xl transition"
        aria-label="Chat WhatsApp"
      >
        {/* ICONA UFFICIALE WHATSAPP (VERDE) */}
        <svg
